package laya.d3.shadowMap {
	...
	public class ParallelSplitShadowMap {
		/**@private */
		public static const MAX_PSSM_COUNT:int = 3;//；laya的PSSM最多支持生成3张不同的阴影贴图
		...
		/**@private */
		private var _shadowMapTextureSize:int = 1024;//laya在这里指定了默认的sm精度，可以调setShadowMapTextureSize（size）这个API直接修改阴影精度
		/**@private */
		...
		//laya的PSSM配合了PCF处理，PCF的等级一共有3个，越高阴影边缘案越平滑，开销越大
